class Door:
    ...
    door_is_open (für geöffnete Türe) sowie ddor_is_locked (für verriegelte Türe).
    ...
    def close_the_door(self):
        """
        Methdoe für das schliessen der Türe.
...
class DoorLock:
    """
    dummy Klasse, damit in der Klasse Tuere kein Fehleruftritt
    """
